...
public class PopUpPanel : MonoBehaviour, IView
{
    ...
    public void Show(bool animate = true, Action completed = null)
    {
    }

    public void Hide(bool animate = true, Action completed = null)
    {
    }
